class ZCL_ZSAP_BOOKSHOP_C_03_MPC definition
  public
...
public section.
  ...
  types:
     TS_BOOKS type ZXMCBOOKS .
  types:
TT_BOOKS type standard table of TS_BOOKS .
  types:
  ...
  constants GC_BOOKS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Books' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZSAP_BOOKSHOP_C_03_MPC====CP' ##NO_TEXT.

  methods DEFINE_BOOKS
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZSAP_BOOKSHOP_C_03_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSAP_BOOKSHOP_CDS_SRV_02' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Books' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property = lo_entity_type->create_property( iv_property_name = 'BookId' iv_abap_fieldname = 'BOOK_ID' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'PublisherId' iv_abap_fieldname = 'PUBLISHER_ID' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 10 ). "#EC NOTEXT
lo_property->set_creatable( abap_true ).
lo_property->set_updatable( abap_true ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CukyField' iv_abap_fieldname = 'CUKY_FIELD' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'UnitField' iv_abap_fieldname = 'UNIT_FIELD' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZXMCBOOKS'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'BooksSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200523220526'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'Books'.                            "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'Books'.                            "#EC NOTEXT
