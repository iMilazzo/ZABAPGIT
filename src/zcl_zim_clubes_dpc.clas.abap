...
protected section.
  ...
  methods ZIM_C_CLUBES_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZIM_CLUBES_MPC=>TS_ZIM_C_CLUBESTYPE
    raising
  ...
  methods ZIM_C_CLUBES_DELETE_ENTITY
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZIM_C_CLUBES_GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZIM_C_CLUBES_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZIM_CLUBES_MPC=>TT_ZIM_C_CLUBESTYPE
  ...
  methods ZIM_I_ELENCOS_BA_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZIM_CLUBES_MPC=>TS_ZIM_I_ELENCOS_BASICTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ZIM_I_ELENCOS_BA_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZIM_CLUBES_MPC=>TT_ZIM_I_ELENCOS_BASICTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ZIM_I_ESTADIOS_B_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZIM_CLUBES_MPC=>TS_ZIM_I_ESTADIOS_BASIC_TOTTYP
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ZIM_I_ESTADIOS_B_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZIM_CLUBES_MPC=>TT_ZIM_I_ESTADIOS_BASIC_TOTTYP
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZIM_I_ESTADIOS_B_UPDATE_ENTITY
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZIM_I_PARTIDASP__CREATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZIM_CLUBES_MPC=>TS_ZIM_I_PARTIDASP_BASICTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZIM_I_PARTIDASP__DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZIM_I_PARTIDASP__GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZIM_I_PARTIDASP__GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZIM_CLUBES_MPC=>TT_ZIM_I_PARTIDASP_BASICTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZIM_I_PARTIDASP__UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
...
*&* This class has been generated on 28.06.2020 23:47:51 in client 400
*&*
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zim_c_clubes_create_entity TYPE zcl_zim_clubes_mpc=>ts_zim_c_clubestype.
 DATA zim_i_elencos_ba_create_entity TYPE zcl_zim_clubes_mpc=>ts_zim_i_elencos_basictype.
 DATA zim_i_estadios_b_create_entity TYPE zcl_zim_clubes_mpc=>ts_zim_i_estadios_basic_tottyp.
 DATA zim_i_partidasp__create_entity TYPE zcl_zim_clubes_mpc=>ts_zim_i_partidasp_basictype.
...
*-------------------------------------------------------------------------*
*             EntitySet -  ZIM_C_CLUBES
*-------------------------------------------------------------------------*
     WHEN 'ZIM_C_CLUBES'.
*     Call the entity set generated method
    zim_c_clubes_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
       	 ...
       	 IMPORTING er_entity          = zim_c_clubes_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = zim_c_clubes_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*-------------------------------------------------------------------------*
*             EntitySet -  ZIM_I_PARTIDASP_BASIC
*-------------------------------------------------------------------------*
     WHEN 'ZIM_I_PARTIDASP_BASIC'.
*     Call the entity set generated method
    zim_i_partidasp__create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
                   iv_entity_set_name = iv_entity_set_name
                   iv_source_name     = iv_source_name
                   io_data_provider   = io_data_provider
                   ...
                   it_navigation_path = it_navigation_path
                   io_tech_request_context = io_tech_request_context
       	 IMPORTING er_entity          = zim_i_partidasp__create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = zim_i_partidasp__create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*-------------------------------------------------------------------------*
      when 'ZIM_I_PARTIDASP_BASIC'.
*     Call the entity set generated method
     zim_i_partidasp__delete_entity(
          EXPORTING iv_entity_name     = iv_entity_name
                    iv_entity_set_name = iv_entity_set_name
                    iv_source_name     = iv_source_name
                    it_key_tab         = it_key_tab
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zim_c_clubes_get_entity TYPE zcl_zim_clubes_mpc=>ts_zim_c_clubestype.
 DATA zim_i_elencos_ba_get_entity TYPE zcl_zim_clubes_mpc=>ts_zim_i_elencos_basictype.
 DATA zim_i_estadios_b_get_entity TYPE zcl_zim_clubes_mpc=>ts_zim_i_estadios_basic_tottyp.
 DATA zim_i_partidasp__get_entity TYPE zcl_zim_clubes_mpc=>ts_zim_i_partidasp_basictype.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          zim_c_clubes_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = zim_c_clubes_get_entity
                         es_response_context = es_response_context
          ).

        IF zim_c_clubes_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = zim_c_clubes_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*     Call the entity set generated method
          zim_i_partidasp__get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = zim_i_partidasp__get_entity
                         es_response_context = es_response_context
          ).

        IF zim_i_partidasp__get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = zim_i_partidasp__get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZIM_CLUBES_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA zim_c_clubes_get_entityset TYPE zcl_zim_clubes_mpc=>tt_zim_c_clubestype.
 DATA zim_i_elencos_ba_get_entityset TYPE zcl_zim_clubes_mpc=>tt_zim_i_elencos_basictype.
 DATA zim_i_estadios_b_get_entityset TYPE zcl_zim_clubes_mpc=>tt_zim_i_estadios_basic_tottyp.
 DATA zim_i_partidasp__get_entityset TYPE zcl_zim_clubes_mpc=>tt_zim_i_partidasp_basictype.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
      zim_c_clubes_get_entityset(
        EXPORTING
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = zim_c_clubes_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = zim_c_clubes_get_entityset
        CHANGING
...
*-------------------------------------------------------------------------*
   WHEN 'ZIM_I_PARTIDASP_BASIC'.
*     Call the entity set generated method
      zim_i_partidasp__get_entityset(
        EXPORTING
         iv_entity_name = iv_entity_name
         iv_entity_set_name = iv_entity_set_name
         iv_source_name = iv_source_name
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = zim_i_partidasp__get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = zim_i_partidasp__get_entityset
        CHANGING
          cr_data = er_entityset
      ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zim_c_clubes_update_entity TYPE zcl_zim_clubes_mpc=>ts_zim_c_clubestype.
 DATA zim_i_elencos_ba_update_entity TYPE zcl_zim_clubes_mpc=>ts_zim_i_elencos_basictype.
 DATA zim_i_estadios_b_update_entity TYPE zcl_zim_clubes_mpc=>ts_zim_i_estadios_basic_tottyp.
 DATA zim_i_partidasp__update_entity TYPE zcl_zim_clubes_mpc=>ts_zim_i_partidasp_basictype.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*     Call the entity set generated method
          zim_c_clubes_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = zim_c_clubes_update_entity
          ).
       IF zim_c_clubes_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = zim_c_clubes_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*-------------------------------------------------------------------------*
      WHEN 'ZIM_I_PARTIDASP_BASIC'.
*     Call the entity set generated method
          zim_i_partidasp__update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         iv_entity_set_name = iv_entity_set_name
                         iv_source_name     = iv_source_name
                         io_data_provider   = io_data_provider
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = zim_i_partidasp__update_entity
          ).
       IF zim_i_partidasp__update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = zim_i_partidasp__update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
* Unit test injection
  ...
  method ZIM_I_PARTIDASP__CREATE_ENTITY.
    if_sadl_gw_dpc_util~get_dpc( )->create_entity( EXPORTING io_data_provider        = io_data_provider
                                                             io_tech_request_context = io_tech_request_context
                                                   IMPORTING es_data                 = er_entity ).
  endmethod.
  ...
  method ZIM_I_PARTIDASP__DELETE_ENTITY.
    if_sadl_gw_dpc_util~get_dpc( )->delete_entity( io_tech_request_context ).
  endmethod.


  method ZIM_I_PARTIDASP__GET_ENTITY.
    if_sadl_gw_dpc_util~get_dpc( )->get_entity( EXPORTING io_tech_request_context = io_tech_request_context
                                                IMPORTING es_data                 = er_entity ).
  endmethod.


  method ZIM_I_PARTIDASP__GET_ENTITYSET.
    if_sadl_gw_dpc_util~get_dpc( )->get_entityset( EXPORTING io_tech_request_context = io_tech_request_context
                                                   IMPORTING et_data                 = et_entityset
                                                             es_response_context     = es_response_context ).
  endmethod.
  ...
  method ZIM_I_PARTIDASP__UPDATE_ENTITY.
    if_sadl_gw_dpc_util~get_dpc( )->update_entity( EXPORTING io_tech_request_context = io_tech_request_context
                                                             io_data_provider        = io_data_provider
                                                   IMPORTING es_data                 = er_entity ).
  endmethod.
