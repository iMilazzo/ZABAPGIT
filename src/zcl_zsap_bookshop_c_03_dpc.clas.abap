class ZCL_ZSAP_BOOKSHOP_C_03_DPC definition
  public
...
protected section.
  ...
  methods BOOKSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZSAP_BOOKSHOP_C_03_MPC=>TS_BOOKS
    raising
  ...
  methods BOOKSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZSAP_BOOKSHOP_C_03_MPC=>TT_BOOKS
...
CLASS ZCL_ZSAP_BOOKSHOP_C_03_DPC IMPLEMENTATION.
...
*&* This class has been generated on 23.05.2020 22:05:35 in client 400
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZSAP_BOOKSHOP_C_03_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA bookset_create_entity TYPE zcl_zsap_bookshop_c_03_mpc=>ts_books.
...
*     Call the entity set generated method
    bookset_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
       	 ...
       	 IMPORTING er_entity          = bookset_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = bookset_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA bookset_get_entity TYPE zcl_zsap_bookshop_c_03_mpc=>ts_books.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          bookset_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = bookset_get_entity
                         es_response_context = es_response_context
          ).

        IF bookset_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = bookset_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZSAP_BOOKSHOP_C_03_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA bookset_get_entityset TYPE zcl_zsap_bookshop_c_03_mpc=>tt_books.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
      bookset_get_entityset(
        EXPORTING
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = bookset_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = bookset_get_entityset
        CHANGING
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA bookset_update_entity TYPE zcl_zsap_bookshop_c_03_mpc=>ts_books.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*     Call the entity set generated method
          bookset_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = bookset_update_entity
          ).
       IF bookset_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = bookset_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    TYPES ty_zxmc_books_1 TYPE zxmc_books ##NEEDED. " reference for where-used list

    DATA(lv_sadl_xml) =
               |<?xml version="1.0" encoding="utf-16"?>| &
               |<sadl:definition xmlns:sadl="http://sap.com/sap.nw.f.sadl" syntaxVersion="V2" >| &
               | <sadl:dataSource type="CDS" name="BooksSet" binding="ZXMC_BOOKS" />| &
               |<sadl:resultSet>| &
               |<sadl:structure name="BooksSet" dataSource="BooksSet" maxEditMode="EX" >| &
               | <sadl:query name="EntitySetDefault">| &
               | </sadl:query>| &
               | <sadl:attribute name="TITLE" binding="TITLE" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="AUTHOR" binding="AUTHOR" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="PUBLISHER_ID" binding="PUBLISHER_ID" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="CUKY_FIELD" binding="CUKY_FIELD" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="PRICE" binding="PRICE" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="UNIT_FIELD" binding="UNIT_FIELD" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="STOCK" binding="STOCK" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="CREATEDAT" binding="CREATEDAT" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="BOOK_ID" binding="BOOK_ID" isOutput="TRUE" isKey="TRUE" />| &
               | <sadl:attribute name="CREATEDBY" binding="CREATEDBY" isOutput="TRUE" isKey="FALSE" />| &
    ...
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20200524010538
               iv_uuid              = 'ZSAP_BOOKSHOP_CDS'
               io_query_control     = me
