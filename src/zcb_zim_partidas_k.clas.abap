class ZCB_ZIM_PARTIDAS_K definition
  public
...
public section.
  ...
  methods CREATE_PERSISTENT
    importing
      !I_ID_PARTIDA type ZIM_ID
      !I_ID_RODADA type ZIM_ID optional
      !I_DATA type TIMESTAMP optional
      !I_ID_ESTADIO type ZIM_ID optional
      !I_PUBLICO type ZIM_PUBLICO optional
      !I_RENDA type ZIM_CURR16 optional
      !I_MOEDA type ZIM_CURR_KEY optional
    returning
      value(RESULT) type ref to ZCL_ZIM_PARTIDAS_K
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to ZCL_ZIM_PARTIDAS_K .
  types:
    begin of TYP_BUSINESS_KEY ,
      ID_PARTIDA type ZIM_ID ,
  ...
  types:
    begin of TYP_DB_DATA ,
      ID_PARTIDA type ZIM_ID ,
      ID_RODADA type ZIM_ID ,
      DATA type TIMESTAMP ,
      ID_ESTADIO type ZIM_ID ,
      PUBLICO type ZIM_PUBLICO ,
      RENDA type ZIM_CURR16 ,
      MOEDA type ZIM_CURR_KEY ,
    end of TYP_DB_DATA .
  types:
...
CLASS ZCB_ZIM_PARTIDAS_K IMPLEMENTATION.


  method CREATE_PERSISTENT.
***BUILD 093901
*      IMPORTING I_ID_PARTIDA TYPE ZIM_ID
*      IMPORTING I_ID_RODADA TYPE ZIM_ID
*      IMPORTING I_DATA TYPE TIMESTAMP
*      IMPORTING I_ID_ESTADIO TYPE ZIM_ID
*      IMPORTING I_PUBLICO TYPE ZIM_PUBLICO
*      IMPORTING I_RENDA TYPE ZIM_CURR16
*      IMPORTING I_MOEDA TYPE ZIM_CURR_KEY
*      RETURNING RESULT TYPE REF TO ZCL_ZIM_PARTIDAS_K
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-ID_PARTIDA = I_ID_PARTIDA.
*>
...
*<  Generated from mapping:
          THE_OBJECT->ID_PARTIDA = I_ID_PARTIDA.
          THE_OBJECT->ID_RODADA = I_ID_RODADA.
          THE_OBJECT->DATA = I_DATA.
          THE_OBJECT->ID_ESTADIO = I_ID_ESTADIO.
          THE_OBJECT->PUBLICO = I_PUBLICO.
          THE_OBJECT->RENDA = I_RENDA.
          THE_OBJECT->MOEDA = I_MOEDA.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_ID_PARTIDA = BUSINESS_KEY-ID_PARTIDA
...
*<Generated from mapping:
  E_BUSINESS_KEY-ID_PARTIDA  = I_DB_DATA-ID_PARTIDA.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_ZIM_PARTIDAS_K,
...
*<  Generated from mapping:
    OBJECT_DATA_ITEM-ID_PARTIDA = THE_OBJECT->ID_PARTIDA.
    OBJECT_DATA_ITEM-ID_RODADA = THE_OBJECT->ID_RODADA.
    OBJECT_DATA_ITEM-DATA = THE_OBJECT->DATA.
    OBJECT_DATA_ITEM-ID_ESTADIO = THE_OBJECT->ID_ESTADIO.
    OBJECT_DATA_ITEM-PUBLICO = THE_OBJECT->PUBLICO.
    OBJECT_DATA_ITEM-RENDA = THE_OBJECT->RENDA.
    OBJECT_DATA_ITEM-MOEDA = THE_OBJECT->MOEDA.
*>
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'ID_PARTIDA'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZIM_PARTIDAS_K'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ID_PARTIDA'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'ID_RODADA'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZIM_PARTIDAS_K'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ID_RODADA'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'DATA'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZIM_PARTIDAS_K'.
    MAP_ATT_INFO-FIELD_NAME1  = 'DATA'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'PUBLICO'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZIM_PARTIDAS_K'.
    MAP_ATT_INFO-FIELD_NAME1  = 'PUBLICO'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'RENDA'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZIM_PARTIDAS_K'.
    MAP_ATT_INFO-FIELD_NAME1  = 'RENDA'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'MOEDA'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZIM_PARTIDAS_K'.
    MAP_ATT_INFO-FIELD_NAME1  = 'MOEDA'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_ZIM_PARTIDAS_K.
...
*<    Generated from Mapping:
      clear: THE_OBJECT->ID_PARTIDA,
             THE_OBJECT->ID_RODADA,
             THE_OBJECT->DATA,
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZIM_PARTIDAS_K.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZIM_PARTIDAS_K> type ZIM_PARTIDAS_K.
*>

*< Generated from mapping:
  select * from ZIM_PARTIDAS_K
           up to I_UPTO rows
...
*   * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZIM_PARTIDAS_K'
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZIM_PARTIDAS_K>.

*< Generated from mapping:
    DB_DATA-ID_PARTIDA = <FS_DB_ZIM_PARTIDAS_K>-ID_PARTIDA.
    DB_DATA-ID_RODADA = <FS_DB_ZIM_PARTIDAS_K>-ID_RODADA.
    DB_DATA-DATA = <FS_DB_ZIM_PARTIDAS_K>-DATA.
    DB_DATA-ID_ESTADIO = <FS_DB_ZIM_PARTIDAS_K>-ID_ESTADIO.
    DB_DATA-PUBLICO = <FS_DB_ZIM_PARTIDAS_K>-PUBLICO.
    DB_DATA-RENDA = <FS_DB_ZIM_PARTIDAS_K>-RENDA.
    DB_DATA-MOEDA = <FS_DB_ZIM_PARTIDAS_K>-MOEDA.
*>
...
*< Generated from mapping:
  select * from ZIM_PARTIDAS_K
           ...
           where ZIM_PARTIDAS_K~ID_PARTIDA =
           I_BUSINESS_KEY_TAB-ID_PARTIDA.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-ID_PARTIDA = BUSINESS_KEY-ID_PARTIDA.
*>
...
* * ZIM_PARTIDAS_K: internal tables for mass operation
  data DB_ITB_ZIM_PARTIDAS_K type STANDARD TABLE OF ZIM_PARTIDAS_K.
  data DB_UTB_ZIM_PARTIDAS_K type STANDARD TABLE OF ZIM_PARTIDAS_K.
  data DB_DTB_ZIM_PARTIDAS_K type STANDARD TABLE OF ZIM_PARTIDAS_K.

* * ZIM_PARTIDAS_K: headlines for tables
  data DB_ILN_ZIM_PARTIDAS_K type ZIM_PARTIDAS_K.
  data DB_ULN_ZIM_PARTIDAS_K type ZIM_PARTIDAS_K.
  data DB_DLN_ZIM_PARTIDAS_K type ZIM_PARTIDAS_K.
...
*< Generated from mapping:
   ...
   DB_ILN_ZIM_PARTIDAS_K-ID_RODADA = <FS_INSERT>-ID_RODADA.
   DB_ILN_ZIM_PARTIDAS_K-DATA = <FS_INSERT>-DATA.
   DB_ILN_ZIM_PARTIDAS_K-ID_ESTADIO = <FS_INSERT>-ID_ESTADIO.
   DB_ILN_ZIM_PARTIDAS_K-PUBLICO = <FS_INSERT>-PUBLICO.
   DB_ILN_ZIM_PARTIDAS_K-RENDA = <FS_INSERT>-RENDA.
   DB_ILN_ZIM_PARTIDAS_K-MOEDA = <FS_INSERT>-MOEDA.


   DB_ILN_ZIM_PARTIDAS_K-ID_PARTIDA = <FS_INSERT>-ID_PARTIDA.
   append DB_ILN_ZIM_PARTIDAS_K to DB_ITB_ZIM_PARTIDAS_K.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZIM_PARTIDAS_K-ID_RODADA = <FS_UPDATE>-ID_RODADA.
   DB_ULN_ZIM_PARTIDAS_K-DATA = <FS_UPDATE>-DATA.
   DB_ULN_ZIM_PARTIDAS_K-ID_ESTADIO = <FS_UPDATE>-ID_ESTADIO.
   DB_ULN_ZIM_PARTIDAS_K-PUBLICO = <FS_UPDATE>-PUBLICO.
   DB_ULN_ZIM_PARTIDAS_K-RENDA = <FS_UPDATE>-RENDA.
   DB_ULN_ZIM_PARTIDAS_K-MOEDA = <FS_UPDATE>-MOEDA.


   DB_ULN_ZIM_PARTIDAS_K-ID_PARTIDA = <FS_UPDATE>-ID_PARTIDA.
   append DB_ULN_ZIM_PARTIDAS_K TO DB_UTB_ZIM_PARTIDAS_K.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZIM_PARTIDAS_K-ID_PARTIDA =
    <FS_DELETE>-BUSINESS_KEY-ID_PARTIDA.

    append DB_DLN_ZIM_PARTIDAS_K TO DB_DTB_ZIM_PARTIDAS_K.
...
* * DB Deletes
  delete ZIM_PARTIDAS_K FROM TABLE DB_DTB_ZIM_PARTIDAS_K.
  if SY-SUBRC <> 0.
    raise exception type CX_OS_DB_DELETE
      exporting
        TABLE = 'ZIM_PARTIDAS_K'.
  endif.

* * DB Inserts
  insert ZIM_PARTIDAS_K FROM TABLE DB_ITB_ZIM_PARTIDAS_K
...
* * DB Updates
  update ZIM_PARTIDAS_K FROM TABLE DB_UTB_ZIM_PARTIDAS_K.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-ID_PARTIDA.
...
*<  Generated from mapping:
  THE_OBJECT->ID_PARTIDA = I_OBJECT_DATA-ID_PARTIDA.
  THE_OBJECT->ID_RODADA = I_OBJECT_DATA-ID_RODADA.
  THE_OBJECT->DATA = I_OBJECT_DATA-DATA.
  THE_OBJECT->ID_ESTADIO = I_OBJECT_DATA-ID_ESTADIO.
  THE_OBJECT->PUBLICO = I_OBJECT_DATA-PUBLICO.
  THE_OBJECT->RENDA = I_OBJECT_DATA-RENDA.
  THE_OBJECT->MOEDA = I_OBJECT_DATA-MOEDA.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_ZIM_PARTIDAS_K.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->ID_PARTIDA = I_BUSINESS_KEY-ID_PARTIDA.
* >
