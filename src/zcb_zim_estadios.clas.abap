class ZCB_ZIM_ESTADIOS definition
  public
...
public section.
  ...
  methods CREATE_PERSISTENT
    importing
      ...
      !I_NOME_ESTADIO type ZIM_ESTADIO optional
      !I_CIDADE type ORT01_GP optional
      !I_UF type REGIO optional
      !I_CAPACIDADE type ZIM_CAPACIDADE optional
      !I_GEOCODE type ZIM_GEOCODE optional
      !I_LATITUDE type ODATA_PL_GEO_LATITUDE optional
      !I_LONGITUDE type ODATA_PL_GEO_LONGITUDE optional
    ...
    returning
      value(RESULT) type ref to ZCL_ZIM_ESTADIOS
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to ZCL_ZIM_ESTADIOS .
  types:
  ...
  types:
    begin of TYP_DB_DATA ,
      ID_ESTADIO type ZIM_ID ,
      NOME_ESTADIO type ZIM_ESTADIO ,
      CIDADE type ORT01_GP ,
      UF type REGIO ,
      CAPACIDADE type ZIM_CAPACIDADE ,
      GEOCODE type ZIM_GEOCODE ,
      LATITUDE type ODATA_PL_GEO_LATITUDE ,
      LONGITUDE type ODATA_PL_GEO_LONGITUDE ,
...
CLASS ZCB_ZIM_ESTADIOS IMPLEMENTATION.


  method CREATE_PERSISTENT.
***BUILD 093901
*      IMPORTING I_ID_ESTADIO TYPE ZIM_ID
*      IMPORTING I_NOME_ESTADIO TYPE ZIM_ESTADIO
*      IMPORTING I_CIDADE TYPE ORT01_GP
*      IMPORTING I_UF TYPE REGIO
*      IMPORTING I_CAPACIDADE TYPE ZIM_CAPACIDADE
*      IMPORTING I_GEOCODE TYPE ZIM_GEOCODE
*      IMPORTING I_LATITUDE TYPE ODATA_PL_GEO_LATITUDE
*      IMPORTING I_LONGITUDE TYPE ODATA_PL_GEO_LONGITUDE
...
*      RETURNING RESULT TYPE REF TO ZCL_ZIM_ESTADIOS
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-ID_ESTADIO = I_ID_ESTADIO.
*>
...
*<  Generated from mapping:
          ...
          THE_OBJECT->NOME_ESTADIO = I_NOME_ESTADIO.
          THE_OBJECT->CIDADE = I_CIDADE.
          THE_OBJECT->UF = I_UF.
          THE_OBJECT->CAPACIDADE = I_CAPACIDADE.
          THE_OBJECT->GEOCODE = I_GEOCODE.
          THE_OBJECT->LATITUDE = I_LATITUDE.
          THE_OBJECT->LONGITUDE = I_LONGITUDE.
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_ID_ESTADIO = BUSINESS_KEY-ID_ESTADIO
...
*<Generated from mapping:
  E_BUSINESS_KEY-ID_ESTADIO  = I_DB_DATA-ID_ESTADIO.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_ZIM_ESTADIOS,
...
*<  Generated from mapping:
    ...
    OBJECT_DATA_ITEM-NOME_ESTADIO = THE_OBJECT->NOME_ESTADIO.
    OBJECT_DATA_ITEM-CIDADE = THE_OBJECT->CIDADE.
    OBJECT_DATA_ITEM-UF = THE_OBJECT->UF.
    OBJECT_DATA_ITEM-CAPACIDADE = THE_OBJECT->CAPACIDADE.
    OBJECT_DATA_ITEM-GEOCODE = THE_OBJECT->GEOCODE.
    OBJECT_DATA_ITEM-LATITUDE = THE_OBJECT->LATITUDE.
    OBJECT_DATA_ITEM-LONGITUDE = THE_OBJECT->LONGITUDE.
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    MAP_ATT_INFO-RECORDNAME = 'ZIM_ESTADIOS'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ID_ESTADIO'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'NOME_ESTADIO'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZIM_ESTADIOS'.
    MAP_ATT_INFO-FIELD_NAME1  = 'NOME_ESTADIO'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'CIDADE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZIM_ESTADIOS'.
    MAP_ATT_INFO-FIELD_NAME1  = 'CIDADE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'UF'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZIM_ESTADIOS'.
    MAP_ATT_INFO-FIELD_NAME1  = 'UF'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'CAPACIDADE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZIM_ESTADIOS'.
    MAP_ATT_INFO-FIELD_NAME1  = 'CAPACIDADE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'GEOCODE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZIM_ESTADIOS'.
    MAP_ATT_INFO-FIELD_NAME1  = 'GEOCODE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'LATITUDE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZIM_ESTADIOS'.
    MAP_ATT_INFO-FIELD_NAME1  = 'LATITUDE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'LONGITUDE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZIM_ESTADIOS'.
    MAP_ATT_INFO-FIELD_NAME1  = 'LONGITUDE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_ZIM_ESTADIOS.
...
*<    Generated from Mapping:
      clear: THE_OBJECT->ID_ESTADIO,
             THE_OBJECT->NOME_ESTADIO,
             THE_OBJECT->CIDADE,
             THE_OBJECT->UF,
             THE_OBJECT->CAPACIDADE,
             THE_OBJECT->GEOCODE,
             THE_OBJECT->LATITUDE,
             THE_OBJECT->LONGITUDE,
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZIM_ESTADIOS.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZIM_ESTADIOS> type ZIM_ESTADIOS.
*>

*< Generated from mapping:
  select * from ZIM_ESTADIOS
           up to I_UPTO rows
...
*   * error handling
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZIM_ESTADIOS>.

*< Generated from mapping:
    DB_DATA-ID_ESTADIO = <FS_DB_ZIM_ESTADIOS>-ID_ESTADIO.
    DB_DATA-NOME_ESTADIO = <FS_DB_ZIM_ESTADIOS>-NOME_ESTADIO.
    DB_DATA-CIDADE = <FS_DB_ZIM_ESTADIOS>-CIDADE.
    DB_DATA-UF = <FS_DB_ZIM_ESTADIOS>-UF.
    DB_DATA-CAPACIDADE = <FS_DB_ZIM_ESTADIOS>-CAPACIDADE.
    DB_DATA-GEOCODE = <FS_DB_ZIM_ESTADIOS>-GEOCODE.
    DB_DATA-LATITUDE = <FS_DB_ZIM_ESTADIOS>-LATITUDE.
    DB_DATA-LONGITUDE = <FS_DB_ZIM_ESTADIOS>-LONGITUDE.
    DB_DATA-CREATED_AT = <FS_DB_ZIM_ESTADIOS>-CREATED_AT.
    DB_DATA-CREATED_BY = <FS_DB_ZIM_ESTADIOS>-CREATED_BY.
    DB_DATA-CHANGED_AT = <FS_DB_ZIM_ESTADIOS>-CHANGED_AT.
    DB_DATA-CHANGED_BY = <FS_DB_ZIM_ESTADIOS>-CHANGED_BY.
*>
...
*< Generated from mapping:
  select * from ZIM_ESTADIOS
           ...
           where ZIM_ESTADIOS~ID_ESTADIO =
           I_BUSINESS_KEY_TAB-ID_ESTADIO.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-ID_ESTADIO = BUSINESS_KEY-ID_ESTADIO.
*>
...
* * ZIM_ESTADIOS: internal tables for mass operation
  data DB_ITB_ZIM_ESTADIOS type STANDARD TABLE OF ZIM_ESTADIOS.
  data DB_UTB_ZIM_ESTADIOS type STANDARD TABLE OF ZIM_ESTADIOS.
  data DB_DTB_ZIM_ESTADIOS type STANDARD TABLE OF ZIM_ESTADIOS.

* * ZIM_ESTADIOS: headlines for tables
  data DB_ILN_ZIM_ESTADIOS type ZIM_ESTADIOS.
  data DB_ULN_ZIM_ESTADIOS type ZIM_ESTADIOS.
  data DB_DLN_ZIM_ESTADIOS type ZIM_ESTADIOS.
...
*< Generated from mapping:
   ...
   DB_ILN_ZIM_ESTADIOS-NOME_ESTADIO = <FS_INSERT>-NOME_ESTADIO.
   DB_ILN_ZIM_ESTADIOS-CIDADE = <FS_INSERT>-CIDADE.
   DB_ILN_ZIM_ESTADIOS-UF = <FS_INSERT>-UF.
   DB_ILN_ZIM_ESTADIOS-CAPACIDADE = <FS_INSERT>-CAPACIDADE.
   DB_ILN_ZIM_ESTADIOS-GEOCODE = <FS_INSERT>-GEOCODE.
   DB_ILN_ZIM_ESTADIOS-LATITUDE = <FS_INSERT>-LATITUDE.
   DB_ILN_ZIM_ESTADIOS-LONGITUDE = <FS_INSERT>-LONGITUDE.
   DB_ILN_ZIM_ESTADIOS-CREATED_AT = <FS_INSERT>-CREATED_AT.
   DB_ILN_ZIM_ESTADIOS-CREATED_BY = <FS_INSERT>-CREATED_BY.
   DB_ILN_ZIM_ESTADIOS-CHANGED_AT = <FS_INSERT>-CHANGED_AT.
   DB_ILN_ZIM_ESTADIOS-CHANGED_BY = <FS_INSERT>-CHANGED_BY.


   DB_ILN_ZIM_ESTADIOS-ID_ESTADIO = <FS_INSERT>-ID_ESTADIO.
   append DB_ILN_ZIM_ESTADIOS to DB_ITB_ZIM_ESTADIOS.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZIM_ESTADIOS-NOME_ESTADIO = <FS_UPDATE>-NOME_ESTADIO.
   DB_ULN_ZIM_ESTADIOS-CIDADE = <FS_UPDATE>-CIDADE.
   DB_ULN_ZIM_ESTADIOS-UF = <FS_UPDATE>-UF.
   DB_ULN_ZIM_ESTADIOS-CAPACIDADE = <FS_UPDATE>-CAPACIDADE.
   DB_ULN_ZIM_ESTADIOS-GEOCODE = <FS_UPDATE>-GEOCODE.
   DB_ULN_ZIM_ESTADIOS-LATITUDE = <FS_UPDATE>-LATITUDE.
   DB_ULN_ZIM_ESTADIOS-LONGITUDE = <FS_UPDATE>-LONGITUDE.
   DB_ULN_ZIM_ESTADIOS-CREATED_AT = <FS_UPDATE>-CREATED_AT.
   DB_ULN_ZIM_ESTADIOS-CREATED_BY = <FS_UPDATE>-CREATED_BY.
   DB_ULN_ZIM_ESTADIOS-CHANGED_AT = <FS_UPDATE>-CHANGED_AT.
   DB_ULN_ZIM_ESTADIOS-CHANGED_BY = <FS_UPDATE>-CHANGED_BY.


   DB_ULN_ZIM_ESTADIOS-ID_ESTADIO = <FS_UPDATE>-ID_ESTADIO.
   append DB_ULN_ZIM_ESTADIOS TO DB_UTB_ZIM_ESTADIOS.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZIM_ESTADIOS-ID_ESTADIO =
    <FS_DELETE>-BUSINESS_KEY-ID_ESTADIO.

    append DB_DLN_ZIM_ESTADIOS TO DB_DTB_ZIM_ESTADIOS.
...
* * DB Deletes
  delete ZIM_ESTADIOS FROM TABLE DB_DTB_ZIM_ESTADIOS.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZIM_ESTADIOS FROM TABLE DB_ITB_ZIM_ESTADIOS
...
* * DB Updates
  update ZIM_ESTADIOS FROM TABLE DB_UTB_ZIM_ESTADIOS.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-ID_ESTADIO.
...
*<  Generated from mapping:
  ...
  THE_OBJECT->NOME_ESTADIO = I_OBJECT_DATA-NOME_ESTADIO.
  THE_OBJECT->CIDADE = I_OBJECT_DATA-CIDADE.
  THE_OBJECT->UF = I_OBJECT_DATA-UF.
  THE_OBJECT->CAPACIDADE = I_OBJECT_DATA-CAPACIDADE.
  THE_OBJECT->GEOCODE = I_OBJECT_DATA-GEOCODE.
  THE_OBJECT->LATITUDE = I_OBJECT_DATA-LATITUDE.
  THE_OBJECT->LONGITUDE = I_OBJECT_DATA-LONGITUDE.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_ZIM_ESTADIOS.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->ID_ESTADIO = I_BUSINESS_KEY-ID_ESTADIO.
* >
